...
@Controller
@RequestMapping(value="/gd11x5")
public class Gd11x5Controller {
	
	@Resource
	private Gd11X5ServiceI service;

	@Resource
	public Gd11X5DataMapper mapper;
	...
	private String getCurrentNum(HttpServletRequest request){
        ...
        List<Gd11X5Data> list =  service.getCurrentNum(selectDay);
        JsonArray array = new JsonArray();
        for(int i=0;i<list.size();i++){
			Gd11X5Data data = list.get(i);
...
//
	...
	private String getBzList(HttpServletRequest request){
        ...
        List<Gd11X5Data> list =  service.getBzList(currentDay);
        JsonArray array = new JsonArray();
        for(int i=0;i<list.size();i++){
			Gd11X5Data data = list.get(i);
...
//
	...
	private String getCountNum(HttpServletRequest request){
		List<Gd11X5Data> list =  service.getMiddleNum("");
