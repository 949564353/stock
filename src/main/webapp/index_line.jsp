...
<head>
	...
	<script>
        ...
        function requestData(selectDay){
            $.ajax({
                url : 'cqssc/getCountNum.sc',// 跳转到 action
                type : 'post',
                cache : false,
                async: false,
                data : {
...
<div align="center" id="day" style="font-size:24px;margin-top:20px">
	重庆时时彩组<span id="selectDay"></span><img onClick="WdatePicker({el:'selectDay',dateFmt:'yyyyMM',onpicked:function(dp){showData(dp);}})" src="js/My97DatePicker/skin/datePicker.gif" width="16" height="22" align="absmiddle" style="cursor:pointer" />20和组10统计信息
</div>
<!-- 图表容器 DOM -->
